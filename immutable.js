...
const newPerson = Object.assign({}, person, {age: 30, name: 'Troy'})
...
const superHeroes = ['batman', 'ironman', 'jessica jones', 'Thor'];
const superVillains = ['Joker', 'lex luther', 'thanos', 'Dark vader']
